...
public class UpdateBranchIntegrationSettingDtoValidator : AbstractValidator<UpdateBranchIntegrationSettingDto>
{
    public UpdateBranchIntegrationSettingDtoValidator()
    {
        RuleFor(x => x.Oid)
